...
namespace mCleaner.Helpers.Controls
{
    public class RichTextBoxEx : RichTextBox
    {
        ...
        {
            // KeyDown event.
            EventManager.RegisterClassHandler(typeof(RichTextBoxEx), KeyDownEvent, new KeyEventHandler(OnKeyDown), /*handledEventsToo*/true);
        }
        ...
        {
            RichTextBoxEx myRichTextBox = (RichTextBoxEx)sender;
